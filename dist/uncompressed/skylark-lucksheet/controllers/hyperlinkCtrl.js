define([
    ...
    '../locale/locale',
    '../store'
], function (m_util, m_getdata, m_refresh, m_location, formula, tooltip, editor, m_constant, m_select, server, sheetmanage, luckysheetFreezen, menuButton, m_get, locale, Store) {
    'use strict';
