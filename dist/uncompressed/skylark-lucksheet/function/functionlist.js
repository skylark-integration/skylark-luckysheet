define([
    ...
    const functionlist = function () {
        let _locale = locale();    // internationalization,get function list
        // internationalization,get function list
        let functionListOrigin = _locale.functionlist;    // add new property f
        // add new property f
        for (let i = 0; i < functionListOrigin.length; i++) {
            let func = functionListOrigin[i];
            func.f = functionImplementation[func.n];
        }
        Store.functionlist = functionListOrigin;    // get n property
        // get n property
