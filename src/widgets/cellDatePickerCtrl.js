define([
    ...
    '../methods/format'
///    '../global/api'
], function (cells, Store, flatpickr, dayjs, m_format) {
    'use strict';
    const {update, datenum_local} = m_format;
    ///const {setCellValue, setCellFormat} = m_api; //TODO
        ...
        cellFocus: function (r, c, cell) {
            ...
            const fp = flatpickr('#luckysheet-input-box', {
                ...
                onChange: function (selectedDates, dateStr) {
                    ...
                    if (!enableTime) {
                        ///formula.updatecell(Store.luckysheetCellUpdate[0], Store.luckysheetCellUpdate[1]); // TODO: lwf
                    }
                }
            });
