define([
    ...
    '../methods/createsheet',
    '../store'
], function (m_constant, sheets, luckysheetformula,imageCtrl, dataVerificationCtrl, pivotTable, luckysheetFreezen, m_get, m_extend, luckysheetConfigsetting,  luckysheetcreatesheet, Store) {
    'use strict';
    ...
    const method = {
        ...
        clear: function (index) {
            ...
            sheets.changeSheet(Store.luckysheetfile[0].index);
        },
        destroy: function () {
