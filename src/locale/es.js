define(function () {
    ...
    return {
        ...
        fontFamily: { MicrosoftYaHei: 'YaHei' },
        fontarray: [
            'Times New Roman',
            'Arial',
            'Tahoma',
        ...
        sort: {
            ...
            'mergeError': 'Hay celdas combinadas en la selección, \xA1esta operación no se puede realizar!'
        },
        filter: {
            filter: 'crear filtro',
            ...
            filiterMoreDataTip: '\xA1Gran cantidad de datos! por favor espera',
            ...
            valueBlank: '(Nulo)',
            mergeError: 'Hay celdas combinadas en la selección del filtro, \xA1esta operación no se puede realizar!'
        },
        rightclick: {
            copy: 'Copiar',
            copyAs: 'Copiar como',
        ...
        screenshot: {
            ...
            screenshotTipTitle: '\xA1Advertencia!',
        ...
        splitText: {
            ...
            splitConfirmToExe: 'Ya hay datos aquí, \xBFquieres reemplazarlos?',
        ...
        sheetconfig: {
            ...
            tipNameRepeat: '\xA1El nombre de la página de la pestaña no se puede repetir! Revísalo',
            ...
            confirmDelete: '\xBFEstás seguro de eliminar',
            redoDelete: 'Se puede deshacer con Ctrl+Z',
            noHide: 'No se puede ocultar, al menos conserva una etiqueta de hoja',
            chartEditNoOpt: '\xA1Esta operación no está permitida en el modo de edición de gráficos!',
        ...
        formula: {
            ...
            find: 'Aprender más',
            tipNotBelongToIf: '\xA1Esta función de celda no pertenece a la fórmula SI!',
        ...
        drag: {
            ...
            afectarPivot: '\xA1Este cambio no se puede realizar en la celda seleccionada porque afectará a la tabla dinámica!',
            ...
            offsetColumnLessZero: '\xA1La columna de desplazamiento no puede ser negativa!',
        ...
        pivotTable: {
            ...
            errorNotAllowEdit: '\xA1Esta operación está prohibida en el modo sin edición!',
            ...
            errorIsDamage: '\xA1Los datos de origen de esta tabla dinámica están dañados!',
            errorNotAllowPivotData: '\xA1No se puede seleccionar la tabla dinámica como datos de origen!',
            errorSelectionRange: '\xA1La selección falló, rango de entrada incorrecto!',
            errorIncreaseRange: '\xA1Por favor, expande el rango seleccionado!',
        ...
        protection: {
            ...
            checkPasswordWrongalert: '\xA1Contraseña incorrecta. Por favor, prueba de nuevo!',
        ...
        edit: { typing: 'mecanografía' },
        websocket: {
            success: 'Éxito de la conexión de WebSocket',
            refresh: 'Se produjo un error en la conexión de WebSocket, \xA1actualice la página!',
            wait: 'Se produjo un error en la conexión de WebSocket, \xA1tenga paciencia!',
