define([
    ...
    function setconfig(v) {
        ...
        if (Store.luckysheetfile != null) {
            Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)].config = v;
        }
    }
    function setvisibledatarow(v) {
        Store.visibledatarow = v;
        if (Store.luckysheetfile != null) {
            Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)].visibledatarow = v;
        }
    }
    function setvisibledatacolumn(v) {
        Store.visibledatacolumn = v;
        if (Store.luckysheetfile != null) {
            Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)].visibledatacolumn = v;
        }
    }
    return {
