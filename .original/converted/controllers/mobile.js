define([
    ...
    './freezen',
    '../store'
], function (a, b, menuButton, luckysheetFreezen, Store) {
    'use strict';
    return function mobileinit() {
        ...
        $(document).on('touchmove', '#luckysheet-grid-window-1', function (event) {
            ...
            if (luckysheet_touchmove_status) {
                ...
                let mouse = a.mouseposition(touch.pageX, touch.pageY);
                let x = mouse[0] + $('#luckysheet-cell-main').scrollLeft();
                let y = mouse[1] + $('#luckysheet-cell-main').scrollTop();
                let row_location = a.rowLocation(y), row = row_location[1], row_pre = row_location[0], row_index = row_location[2];
                let col_location = a.colLocation(x), col = col_location[1], col_pre = col_location[0], col_index = col_location[2];
