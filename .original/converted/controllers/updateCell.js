define([
    ...
    './server',
    '../global/method'
], function (pivotTable, luckysheetFreezen, menuButton, conditionformat, alternateformat, cellDatePickerCtrl, dataVerificationCtrl, a, b, c, d, e, formula, f, cleargridelement, g, Store, server, method) {
    'use strict';
