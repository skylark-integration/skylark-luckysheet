define([
    ...
    '../global/format',
    '../global/api'
], function (menuButton, formula, Store, flatpickr, dayjs, a, b) {
    'use strict';
    ...
    const cellDatePickerCtrl = {
        cellFocus: function (r, c, cell) {
            ...
            let defaultDate = a.update('yyyy-MM-dd hh:mm:ss', cell.v);
            ...
            const fp = flatpickr('#luckysheet-input-box', {
                ...
                onChange: function (selectedDates, dateStr) {
                    let currentVal = a.datenum_local(new Date(selectedDates));
                    $('#luckysheet-rich-text-editor').html(dateStr);
                    b.setCellValue(r, c, currentVal, { isRefresh: false });
                    b.setCellFormat(r, c, 'ct', cell.ct);
                    if (!enableTime) {
