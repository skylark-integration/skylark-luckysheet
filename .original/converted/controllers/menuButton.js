define([
    ...
    '../store',
    '../locale/locale'
], function (a, b, luckysheetConfigsetting, luckysheetMoreFormat, alternateformat, conditionformat, server, c, luckysheetFreezen, luckysheetsizeauto, d, luckysheetSearchReplace, luckysheetLocationCell, ifFormulaGenerator, e, insertFormula, sheetmanage, luckysheetPostil, f, tooltip, editor, g, h, i, luckysheetformula, j, k, l, m, n, o, p, q, r, s, t, u, Store, locale) {
    'use strict';
    const menuButton = {
        ...
        focus: function ($obj, value) {
            if ($obj.attr('id') == 'luckysheet-icon-font-family-menuButton') {
                if (k.isdatatypemulti(value)['num']) {
                    let _locale = locale();
            ...
            for (let i = 0; i < itemdata.length; i++) {
                ...
                if (item.value == 'split') {
                    ...
                    if (item.example == 'more') {
                        itemset += t.replaceHtml(_this.item, {
                            'value': item.value,
                            'name': item.text,
                            'example': '',
        ...
        cancelPaintModel: function () {
            ...
            if (Store.luckysheet_copy_save['dataSheetIndex'] == Store.currentSheetIndex) {
                ...
                Store.luckysheetfile[q.getSheetIndex(Store.luckysheet_copy_save['dataSheetIndex'])].luckysheet_selection_range = [];
            }
        ...
        initialMenuButton: function () {
            ...
            $('#luckysheet-icon-paintformat').click(function () {
                ...
                for (let r = Store.luckysheet_select_save[0].row[0]; r <= Store.luckysheet_select_save[0].row[1]; r++) {
                    ...
                    for (let c = Store.luckysheet_select_save[0].column[0]; c <= Store.luckysheet_select_save[0].column[1]; c++) {
                        ...
                        if (t.getObjType(cell) == 'object' && 'mc' in cell && cell.mc.rs != null) {
                            HasMC = true;
                        }
                    }
                }
            ...
            $('#luckysheet-icon-fmt-other').click(function () {
                ...
                if ($menuButton.length == 0) {
                    ...
                    let menu = t.replaceHtml(_this.menu, {
                        'id': 'fmt-other',
                        'item': itemset,
                        'subclass': '',
                        'sub': ''
                    ...
                    let submenu = t.replaceHtml(_this.menu, {
                        'id': 'fmtOtherSelf',
                        'item': subitemset,
                ...
                t.mouseclickposition($menuButton, menuleft, $(this).offset().top + 25, 'lefttop');
            });
            $('#luckysheet-icon-font-family').mousedown(function (e) {
                p.hideMenuByCancel(e);
                e.stopPropagation();
            }).click(function () {
                let menuButtonId = $(this).attr('id') + '-menuButton';
                let $menuButton = $('#' + menuButtonId);
            ...
            $('#luckysheet-icon-text-color-menu').mousedown(function (e) {
                ...
                if ($menuButton.length == 0) {
                    ...
                    let coloritem = t.replaceHtml(_this.coloritem, {
                        'class': 'luckysheet-icon-alternateformat',
                        'name': locale_toolbar.alternatingColors + '...'
                    });
                    let menu = t.replaceHtml(_this.color, {
                        'id': menuButtonId,
                        'coloritem': coloritem,
                        'colorself': subid,
                        'sub': '',
                ...
                setTimeout(function () {
                    ...
                    t.mouseclickposition($menuButton, menuleft - 28, offsetTop, 'lefttop');
                }, 1);
            });
            ...
            $('#luckysheet-icon-border-all').click(function () {
                if (!u.checkProtectionFormatCells(Store.currentSheetIndex)) {
                    return;
                }
                let d = editor.deepCopyFlowData(Store.flowdata);
                ...
                Store.config = cfg;
                Store.luckysheetfile[q.getSheetIndex(Store.currentSheetIndex)].config = Store.config;
                setTimeout(function () {
            ...
            $('#luckysheet-icon-border-menu').click(function () {
                ...
                if ($menuButton.length == 0) {
                    ...
                    const iconfontObject = b.iconfontObjects.border;
                    let itemset = _this.createButtonMenu(itemdata);
                    let menu = t.replaceHtml(_this.menu, {
                        'id': 'border-menu',
                        'item': itemset,
                    ...
                    let subcolormenuid = 'luckysheet-icon-borderColor-menuButton';
                    let colormenu = t.replaceHtml(_this.color, {
                        'id': subcolormenuid,
                        'coloritem': '',
                        'colorself': '',
                ...
                t.mouseclickposition($menuButton, menuleft - 28, $(this).offset().top + 25, 'lefttop');
            });
            $('#luckysheet-icon-merge-button').click(function () {
                if (!u.checkProtectionNotEnable(Store.currentSheetIndex)) {
                    return;
                }
                if (a.selectIsOverlap()) {
                    if (f.isEditMode()) {
                        alert('不能合并重叠区域');
                    } else {
                ...
                if (Store.config['merge'] != null) {
                    ...
                    for (let s = 0; s < Store.luckysheet_select_save.length; s++) {
                        ...
                        has_PartMC = f.hasPartMC(Store.config, r1, r2, c1, c2);
                        if (has_PartMC) {
                            break;
                        }
                    }
            ...
            $('#luckysheet-icon-align-menu').click(function () {
                ...
                if ($menuButton.length == 0) {
                    ...
                    const iconfontObject = b.iconfontObjects.align;
                    let itemset = _this.createButtonMenu(itemdata);
                    let menu = t.replaceHtml(_this.menu, {
                        'id': 'align-menu',
                        'item': itemset,
            ...
            $('#luckysheet-icon-textwrap-menu').click(function () {
                ...
                if ($menuButton.length == 0) {
                    ...
                    const iconfontObject = b.iconfontObjects.textWrap;
                    let itemset = _this.createButtonMenu(itemdata);
                    let menu = t.replaceHtml(_this.menu, {
                        'id': 'textwrap-menu',
                        'item': itemset,
            ...
            $('#luckysheet-icon-rotation-menu').click(function () {
                ...
                if ($menuButton.length == 0) {
                    ...
                    const iconfontObject = b.iconfontObjects.rotation;
                    let itemset = _this.createButtonMenu(itemdata);
                    let menu = t.replaceHtml(_this.menu, {
                        'id': 'rotation-menu',
                        'item': itemset,
            ...
            $('#luckysheet-icon-freezen-menu').click(function () {
                ...
                if ($menuButton.length == 0) {
                    ...
                    $menuButton.find('.luckysheet-cols-menuitem').click(function () {
                        ...
                        if (itemvalue == 'freezenRow') {
                            ...
                            let row_st = c.luckysheet_searcharray(Store.visibledatarow, scrollTop);
                            if (row_st == -1) {
                                row_st = 0;
                            }
                            ...
                            let col_st = c.luckysheet_searcharray(Store.visibledatacolumn, scrollLeft);
                            if (col_st == -1) {
                                col_st = 0;
                            }
                ...
                t.mouseclickposition($menuButton, menuleft - 68, $(this).offset().top + 25, 'lefttop');
            });
                ...
                if ($menuButton.length == 0) {
                    ...
                    $menuButton.find('.luckysheet-cols-menuitem').click(function () {
                        ...
                        if (itemvalue == 'diysort') {
                            ...
                            i.sortSelection(true);
                        } else if (itemvalue == 'desc') {
                            i.sortSelection(false);
            ...
            $('#luckysheet-icon-function-menu').click(function () {
                ...
                if ($menuButton.length == 0) {
                    ...
                    $menuButton.find('.luckysheet-cols-menuitem').click(function () {
                        ...
                        if (itemvalue == 'if') {
                            ...
                            e.luckysheetupdateCell(row_index, col_index, Store.flowdata);
                ...
                t.mouseclickposition($menuButton, menuleft - 48, $(this).offset().top + 25, 'lefttop');
            });
            ...
            $('#luckysheet-icon-conditionformat').click(function () {
                ...
                if ($menuButton.length == 0) {
                    ...
                    let submenu2 = t.replaceHtml(_this.menu, {
                    ...
                    let submenu6 = t.replaceHtml(_this.menu, {
                        'id': 'deleteRule',
                        'item': subitemset6,
                        'subclass': 'luckysheet-menuButton-sub'
                    });
            ...
            $('#luckysheet-icon-protection').click(function () {
                ...
                u.openProtectionModal(sheetFile);
            });
            ...
            if (attr == 'ct') {
                for (let r = row_st; r <= row_ed; r++) {
                    ...
                    for (let c = col_st; c <= col_ed; c++) {
                        ...
                        if (t.getObjType(cell) == 'object') {
                            value = d[r][c]['v'];
                        } else {
                            value = d[r][c];
                        }
                        if (foucsStatus != '@' && f.isRealNum(value)) {
                            value = parseFloat(value);
                        }
                        let mask = g.update(foucsStatus, value);
                        let type = 'n';
                        if (g.is_date(foucsStatus) || foucsStatus === 14 || foucsStatus === 15 || foucsStatus === 16 || foucsStatus === 17 || foucsStatus === 18 || foucsStatus === 19 || foucsStatus === 20 || foucsStatus === 21 || foucsStatus === 22 || foucsStatus === 45 || foucsStatus === 46 || foucsStatus === 47) {
                            type = 'd';
                ...
                for (let r = row_st; r <= row_ed; r++) {
                    ...
                    for (let c = col_st; c <= col_ed; c++) {
                        let value = d[r][c];
                        if (t.getObjType(value) == 'object') {
                            s.updateInlineStringFormatOutside(value, attr, foucsStatus);
        ...
        updateFormat: function (d, attr, foucsStatus) {
            ...
            if (attr in s.inlineStyleAffectAttribute) {
                if (parseInt($('#luckysheet-input-box').css('top')) > 0) {
                    let value = $('#luckysheet-input-box').text();
                    if (value.substr(0, 1) != '=') {
                        let cell = d[Store.luckysheetCellUpdate[0]][Store.luckysheetCellUpdate[1]];
                        s.updateInlineStringFormat(cell, attr, foucsStatus, luckysheetformula.rangeResizeTo);
                    }
                }
            }
            let cfg = $.extend(true, {}, Store.config);
            ...
            for (let s = 0; s < Store.luckysheet_select_save.length; s++) {
                ...
                if (attr == 'tb' || attr == 'tr' || attr == 'fs') {
                    cfg = l.rowlenByRange(d, row_st, row_ed, cfg);
                }
            }
            let allParam = {};
            if (attr == 'tb' || attr == 'tr' || attr == 'fs') {
            ...
            h.jfrefreshgrid(d, Store.luckysheet_select_save, allParam, false);
        },
        updateFormat_mc: function (d, foucsStatus) {
            ...
            if (foucsStatus == 'mergeCancel') {
                ...
                for (let i = 0; i < Store.luckysheet_select_save.length; i++) {
                    ...
                    for (let r = r1; r <= r2; r++) {
                        for (let c = c1; c <= c2; c++) {
                            let cell = d[r][c];
                            if (t.getObjType(cell) == 'object' && 'mc' in cell) {
                                isHasMc = true;
                                break;
                            }
                        }
                    ...
                    for (let i = 0; i < Store.luckysheet_select_save.length; i++) {
                        ...
                        if (foucsStatus == 'mergeAll') {
                            ...
                            for (let r = r1; r <= r2; r++) {
                                for (let c = c1; c <= c2; c++) {
                                    let cell = d[r][c];
                                    if (cell != null && (!f.isRealNull(cell.v) || cell.f != null) && !isfirst) {
                                        fv = $.extend(true, {}, cell);
                                        isfirst = true;
                                    }
                                    d[r][c] = {
            ...
            h.jfrefreshgrid(d, Store.luckysheet_select_save, { 'cfg': cfg });
        ...
        changeMenuButtonDom: function (attr, foucsStatus, _locale) {
            ...
            if (attr == 'bl') {
                ...
                if (foucsStatus != null) {
                    if (k.isdatatypemulti(foucsStatus)['num']) {
        ...
        inputMenuButtonFocus: function (focusTarget) {
            ...
            if (startContainer.parentNode.tagName == 'SPAN') {
                ...
                let stylelist = s.convertCssToStyleList(cssText);
        ...
        checkstatus: function (d, r, c, a) {
            ...
            return n.checkstatusByCell(foucsStatus, a);
        },
        ...
        mergeborer: function (d, row_index, col_index) {
            ...
            if (t.getObjType(value) == 'object' && 'mc' in value) {
        ...
        getCellRealSize: function (d, cell_r, cell_c) {
            ...
            if (!!celldata && celldata['mc'] != null) {
                ...
                let config = q.getluckysheetfile()[q.getSheetIndex(Store.currentSheetIndex)]['config'];
        ...
        activeFormulaInput: function (row_index, col_index, rowh, columnh, formula, isnull) {
            ...
            e.luckysheetupdateCell(row_index, col_index, Store.flowdata, true);
            if (isnull) {
        ...
        backFormulaInput: function (d, r, c, rowh, columnh, formula) {
            let _this = this;
            let f = '=' + formula.toUpperCase() + '(' + q.getRangetxt(Store.currentSheetIndex, {
                'row': rowh,
                'column': columnh
        ...
        checkNoNullValue: function (cell) {
            let v = cell;
            if (t.getObjType(v) == 'object') {
                v = v.v;
            }
            if (!f.isRealNull(v) && k.isdatatypemulti(v).num && (cell.ct == null || cell.ct.t == null || cell.ct.t == 'n' || cell.ct.t == 'g')) {
                return true;
            } else {
                return false;
            }
        ...
        getStyleByCell: function (d, r, c) {
            ...
            if (!isInline) {
                style += n.getFontStyleByCell(cell, checksAF, checksCF);
            }
            return style;
        },
        fontSelectList: [],
