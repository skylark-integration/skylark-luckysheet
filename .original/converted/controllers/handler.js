define([
...
], function (mobileinit, luckysheetConfigsetting, luckysheetFreezen, pivotTable, luckysheetDropCell, luckysheetPostil, imageCtrl, hyperlinkCtrl, dataVerificationCtrl, menuButton, conditionformat, alternateformat, ifFormulaGenerator, sheetmanage, server, a, b, luckysheetsizeauto, c, d, selection, controlHistory, splitColumn, e, f, g, h, i, j, k, l, m, n, browser, formula, o, luckysheetscrollevent, p, q, tooltip, editor, r, method, s, t, locale, Store, u) {
    'use strict';
    return function luckysheetHandler() {
        ...
        $('#luckysheet-grid-window-1').mousewheel(function (event, delta) {
            ...
            if (Store.visibledatacolumn_unique != null) {
                ...
                visibledatacolumn_c = i.ArrayUnique(visibledatacolumn_c);
            ...
            if (Store.visibledatarow_unique != null) {
                ...
                visibledatarow_c = i.ArrayUnique(visibledatarow_c);
                Store.visibledatarow_unique = visibledatarow_c;
            }
            let col_st = b.luckysheet_searcharray(visibledatacolumn_c, scrollLeft);
            let row_st = b.luckysheet_searcharray(visibledatarow_c, scrollTop);
            if (luckysheetFreezen.freezenhorizontaldata != null) {
                row_st = b.luckysheet_searcharray(visibledatarow_c, scrollTop + luckysheetFreezen.freezenhorizontaldata[0]);
            }
            let colscroll = 0;
            let rowscroll = 0;
            let scrollNum = event.deltaFactor < 40 ? 1 : event.deltaFactor < 80 ? 2 : 3;
        ...
        $('#luckysheet-cell-main, #luckysheetTableContent').mousedown(function (event) {
            ...
            let mouse = k.mouseposition(event.pageX, event.pageY);
            ...
            let row_location = k.rowLocation(y), row = row_location[1], row_pre = row_location[0], row_index = row_location[2];
            let col_location = k.colLocation(x), col = col_location[1], col_pre = col_location[0], col_index = col_location[2];
            ...
            if (Store.flowdata[row_index] != null && Store.flowdata[row_index][col_index] != null && Store.flowdata[row_index][col_index].dd != null) {
                if (luckysheetConfigsetting.fireMousedown != null && i.getObjType(luckysheetConfigsetting.fireMousedown) == 'function') {
            ...
            if (parseInt($input.css('top')) > 0) {
                if (formula.rangestart || formula.rangedrag_column_start || formula.rangedrag_row_start || formula.israngeseleciton()) {
                    ...
                    if (event.shiftKey) {
                        ...
                        d.luckysheet_count_show(left, top, width, height, rowseleted, columnseleted);
                        last['row'] = rowseleted;
                ...
                if (g.checkProtectionSelectLockedOrUnLockedCells(row_index, col_index, Store.currentSheetIndex)) {
                    Store.luckysheet_select_status = true;
                }
            }
            if ($('#luckysheet-multiRange-dialog').is(':visible')) {
                ...
                d.selectionCopyShow(conditionformat.selectRange);
            ...
            if ($('#luckysheet-singleRange-dialog').is(':visible')) {
                ...
                let range = j.getRangetxt(Store.currentSheetIndex, {
                    'row': [
                        row_index,
                        row_index
                    ],
            ...
            if ($('#luckysheet-dataVerificationRange-dialog').is(':visible')) {
                ...
                d.selectionCopyShow(dataVerificationCtrl.selectRange);
                ...
                if (formula.rangetosheet != Store.currentSheetIndex) {
                    range = Store.luckysheetfile[j.getSheetIndex(Store.currentSheetIndex)].name + '!' + range;
                }
            ...
            if (Store.luckysheet_select_status) {
                if (event.shiftKey) {
                    ...
                    if ($('#luckysheet-alternateformat-rangeDialog').is(':visible')) {
                        $('#luckysheet-alternateformat-rangeDialog input').val(j.getRangetxt(Store.currentSheetIndex, Store.luckysheet_select_save));
                    }
                    if (pivotTable.luckysheet_pivotTable_select_state) {
                        $('#luckysheet-pivotTable-range-selection-input').val(Store.luckysheetfile[j.getSheetIndex(Store.currentSheetIndex)].name + '!' + i.chatatABC(Store.luckysheet_select_save[0]['column'][0]) + (Store.luckysheet_select_save[0]['row'][0] + 1) + ':' + i.chatatABC(Store.luckysheet_select_save[0]['column'][1]) + (Store.luckysheet_select_save[0]['row'][1] + 1));
                    }
                } else if (event.ctrlKey) {
            ...
            if (event.which == '3') {
                ...
                i.$$('#luckysheet-cols-rows-data .luckysheet-menuseparator').style.display = 'block';
                i.$$('#luckysheet-cols-rows-handleincell .luckysheet-menuseparator').style.display = 'block';
                if (obj_s['row'] != null && obj_s['row'][0] == 0 && obj_s['row'][1] == Store.flowdata.length - 1) {
                    ...
                    i.$$('#luckysheet-cols-rows-add .luckysheet-menuseparator').style.display = 'block';
                    i.$$('#luckysheet-top-left-add-selected').style.display = cellRightClickConfig.insertColumn ? 'block' : 'none';
                    i.$$('#luckysheet-bottom-right-add-selected').style.display = cellRightClickConfig.insertColumn ? 'block' : 'none';
                    i.$$('#luckysheet-del-selected').style.display = cellRightClickConfig.deleteColumn ? 'block' : 'none';
                    i.$$('#luckysheet-hide-selected').style.display = cellRightClickConfig.hideColumn ? 'block' : 'none';
                    i.$$('#luckysheet-show-selected').style.display = cellRightClickConfig.hideColumn ? 'block' : 'none';
                    i.$$('#luckysheet-column-row-width-selected').style.display = cellRightClickConfig.columnWidth ? 'block' : 'none';
                    if (!cellRightClickConfig.copy && !cellRightClickConfig.copyAs && !cellRightClickConfig.paste) {
                        i.$$('#luckysheet-cols-rows-add .luckysheet-menuseparator').style.display = 'none';
                        if (!cellRightClickConfig.insertColumn && !cellRightClickConfig.deleteColumn && !cellRightClickConfig.hideColumn && !cellRightClickConfig.columnWidth) {
                            i.$$('#luckysheet-cols-rows-data .luckysheet-menuseparator').style.display = 'none';
                        }
                    }
                    if (!cellRightClickConfig.insertColumn && !cellRightClickConfig.deleteColumn && !cellRightClickConfig.hideColumn && !cellRightClickConfig.columnWidth) {
                        i.$$('#luckysheet-cols-rows-add .luckysheet-menuseparator').style.display = 'none';
                    ...
                    Store.luckysheet_cols_menu_status = true;
                    i.$$('#luckysheet-cols-rows-add .luckysheet-menuseparator').style.display = 'block';
                    i.$$('#luckysheet-top-left-add-selected').style.display = cellRightClickConfig.insertRow ? 'block' : 'none';
                    i.$$('#luckysheet-bottom-right-add-selected').style.display = cellRightClickConfig.insertRow ? 'block' : 'none';
                    i.$$('#luckysheet-del-selected').style.display = cellRightClickConfig.deleteRow ? 'block' : 'none';
                    i.$$('#luckysheet-hide-selected').style.display = cellRightClickConfig.hideRow ? 'block' : 'none';
                    i.$$('#luckysheet-show-selected').style.display = cellRightClickConfig.hideRow ? 'block' : 'none';
                    i.$$('#luckysheet-column-row-width-selected').style.display = cellRightClickConfig.rowHeight ? 'block' : 'none';
                    if (!cellRightClickConfig.copy && !cellRightClickConfig.copyAs && !cellRightClickConfig.paste) {
                        i.$$('#luckysheet-cols-rows-add .luckysheet-menuseparator').style.display = 'none';
                    ...
                    if (!cellRightClickConfig.copy && !cellRightClickConfig.copyAs && !cellRightClickConfig.paste) {
                        i.$$('#luckysheet-cols-rows-handleincell .luckysheet-menuseparator').style.display = 'none';
                ...
                i.showrightclickmenu($('#luckysheet-rightclick-menu'), x, y);
            }
            server.saveParam('mv', Store.currentSheetIndex, Store.luckysheet_select_save);
            ...
            let row_location = k.rowLocation(y), row_index = row_location[2];
            let col_location = k.colLocation(x), col_index = col_location[2];
            let margeset = menuButton.mergeborer(Store.flowdata, row_index, col_index);
            if (!!margeset) {
                row_index = margeset.row[2];
                col_index = margeset.column[2];
        ...
        document.getElementById('luckysheet-cell-main').addEventListener('drop', function (e) {
            ...
            if (files.length == 1 && files[0].type.indexOf('image') > -1) {
                if (!g.checkProtectionAuthorityNormal(Store.currentSheetIndex, 'editObjects')) {
                    return;
                }
        ...
        $(document).on('mousemove.luckysheetEvent', function (event) {
            luckysheetPostil.overshow(event);
            hyperlinkCtrl.overshow(event);
            ...
            if (formula.functionResizeStatus) {
                ...
                let row_index = b.luckysheet_searcharray(Store.luckysheet_sheet_move_data.widthlist, left + Store.luckysheet_sheet_move_data.curleft);
                ...
                function mouseRender() {
                    ...
                    if (Store.luckysheet_select_status) {
                        ...
                        if ($('#luckysheet-alternateformat-rangeDialog').is(':visible')) {
                            $('#luckysheet-alternateformat-rangeDialog input').val(j.getRangetxt(Store.currentSheetIndex, Store.luckysheet_select_save[Store.luckysheet_select_save.length - 1]));
                        }
                        if (pivotTable.luckysheet_pivotTable_select_state) {
                            $('#luckysheet-pivotTable-range-selection-input').val(Store.luckysheetfile[j.getSheetIndex(Store.currentSheetIndex)].name + '!' + i.chatatABC(Store.luckysheet_select_save[0]['column'][0]) + (Store.luckysheet_select_save[0]['row'][0] + 1) + ':' + i.chatatABC(Store.luckysheet_select_save[0]['column'][1]) + (Store.luckysheet_select_save[0]['row'][1] + 1));
                        }
                        ...
                        const mouse = k.mouseposition(event.pageX, event.pageY);
        ...
        $(document).on('mouseup.luckysheetEvent', function (event) {
            ...
            if (!!Store.chartparam.luckysheetCurrentChartResize) {
                ...
                if (Store.chartparam.luckysheetInsertChartTosheetChange) {
                    ...
                    var x = Store.chartparam.luckysheetCurrentChartResizeXy[4];
            ...
            if (Store.luckysheet_rows_change_size) {
                ...
                Store.config = cfg;
                Store.luckysheetfile[j.getSheetIndex(Store.currentSheetIndex)].config = Store.config;
                server.saveParam('cg', Store.currentSheetIndex, cfg['rowlen'], { 'k': 'rowlen' });
                Store.luckysheetfile[j.getSheetIndex(Store.currentSheetIndex)].images = images;
                server.saveParam('all', Store.currentSheetIndex, images, { 'k': 'images' });
                imageCtrl.images = images;
                imageCtrl.allImagesShow();
                p.jfrefreshgrid_rhcw(Store.flowdata.length, null);
            }
            if (Store.luckysheet_cols_change_size) {
                ...
                imageCtrl.images = images;
                imageCtrl.allImagesShow();
                p.jfrefreshgrid_rhcw(null, Store.flowdata[0].length);
                setTimeout(function () {
                    p.luckysheetrefreshgrid();
                }, 1);
            }
            ...
            if (Store.luckysheet_cell_selected_move) {
                ...
                let mouse = k.mouseposition(event.pageX, event.pageY);
                if (!g.checkProtectionLockedRangeList(Store.luckysheet_select_save, Store.currentSheetIndex)) {
                    return;
                }
                let scrollLeft = $('#luckysheet-cell-main').scrollLeft();
                let scrollTop = $('#luckysheet-cell-main').scrollTop();
                ...
                let y = mouse[1] + scrollTop;
                let winH = $(window).height() + scrollTop - Store.sheetBarHeight - Store.statisticBarHeight, winW = $(window).width() + scrollLeft;
                let row_index = k.rowLocation(y)[2];
                let col_index = k.colLocation(x)[2];
                let row_index_original = Store.luckysheet_cell_selected_move_index[0], col_index_original = Store.luckysheet_cell_selected_move_index[1];
                ...
                let data = q.getdatabyselection(last);
                let cfg = $.extend(true, {}, Store.config);
                if (cfg['merge'] == null) {
                    cfg['merge'] = {};
                }
                ...
                if (m.hasPartMC(cfg, last['row'][0], last['row'][1], last['column'][0], last['column'][1])) {
                    if (m.isEditMode()) {
                ...
                if (!g.checkProtectionLockedRangeList([{
                            row: [
                                row_s,
                                row_e
                            ],
                ...
                if (m.hasPartMC(cfg, row_s, row_e, col_s, col_e)) {
                    if (m.isEditMode()) {
                        alert(locale_drag.noMerge);
                    } else {
                        tooltip.info('<i class="fa fa-exclamation-triangle"></i>', locale_drag.noMerge);
                ...
                let borderInfoCompute = s.getBorderInfoCompute(Store.currentSheetIndex);
                let RowlChange = null;
                for (let r = last['row'][0]; r <= last['row'][1]; r++) {
                    ...
                    for (let c = last['column'][0]; c <= last['column'][1]; c++) {
                        let cell = d[r][c];
                        if (i.getObjType(cell) == 'object' && 'mc' in cell) {
                ...
                if (RowlChange) {
                    cfg = l.rowlenByRange(d, last['row'][0], last['row'][1], cfg);
                    cfg = l.rowlenByRange(d, row_s, row_e, cfg);
                }
                let cdformat = $.extend(true, [], Store.luckysheetfile[j.getSheetIndex(Store.currentSheetIndex)]['luckysheet_conditionformat_save']);
                ...
                p.jfrefreshgrid(d, range, allParam);
                d.selectHightlightShow();
        ...
        $('#luckysheet-cell-main div.luckysheet-cs-draghandle').mousedown(function (event) {
            if (m.isEditMode() || Store.allowEdit === false) {
                return;
            }
            ...
            let x = mouse[0] + $('#luckysheet-cell-main').scrollLeft();
            let y = mouse[1] + $('#luckysheet-cell-main').scrollTop();
            let row_location = k.rowLocation(y), row_pre = row_location[0], row = row_location[1], row_index = row_location[2];
            let col_location = k.colLocation(x), col_pre = col_location[0], col = col_location[1], col_index = col_location[2];
        ...
        $('#luckysheet-cell-main div.luckysheet-cs-fillhandle').mousedown(function (event) {
            ...
            for (let r = r1 + 1; r < Store.flowdata.length; r++) {
                if (c0 - 1 >= 0 && c1 + 1 < Store.flowdata[0].length) {
                    ...
                    if (r == r1 + 1) {
                        if ((cell1 == null || m.isRealNull(cell1.v)) && (cell2 == null || m.isRealNull(cell2.v))) {
                            dropCellState = false;
                            break;
                        } else {
                            dropCellState = true;
                    ...
                    if (r == r1 + 1) {
                        if (cell == null || m.isRealNull(cell.v)) {
                            dropCellState = false;
                            break;
                        } else {
                            dropCellState = true;
        ...
        $('#luckysheet-bottom-add-row').on('click', function (e) {
            ...
            o.luckysheetextendtable('row', Store.flowdata.length - 1, value);
        });
        ...
        $('#luckysheet-copy-btn, #luckysheet-cols-copy-btn, #luckysheet-paste-btn-title').click(function (event) {
            ...
            if (Store.config['merge'] != null) {
                ...
                for (let s = 0; s < Store.luckysheet_select_save.length; s++) {
                    ...
                    has_PartMC = m.hasPartMC(Store.config, r1, r2, c1, c2);
                    if (has_PartMC) {
                        break;
                    }
                }
            ...
            let cdformat = Store.luckysheetfile[j.getSheetIndex(Store.currentSheetIndex)].luckysheet_conditionformat_save;
            ...
            if (Store.luckysheet_select_save.length > 1) {
                ...
                if (!isSameRow && !isSameCol || d.selectIsOverlap()) {
                    if (m.isEditMode()) {
                        alert(locale_drag.noMulti);
                    } else {
                        tooltip.info(locale_drag.noMulti, '');
        ...
        $('#luckysheet-pivot-btn-title').click(function (e) {
            if (!g.checkProtectionAuthorityNormal(Store.currentSheetIndex, 'usePivotTablereports')) {
                return;
            }
        ...
        $('#luckysheet-chart-btn-screenshot').click(function () {
            ...
            t.luckysheetDrawMain(scrollWidth, scrollHeight, ch_width, rh_height, 1, 1, null, null, newCanvas);
            ...
            ctx_newCanvas.strokeStyle = f.luckysheetdefaultstyle.strokeStyle;
        ...
        $('#luckysheet-splitColumn-btn-title').click(function () {
            if (!g.checkProtectionNotEnable(Store.currentSheetIndex)) {
                return;
            }
        ...
        $('#luckysheet-imgUpload').on('change', function (e) {
            if (!g.checkProtectionAuthorityNormal(Store.currentSheetIndex, 'editObjects', false)) {
                return;
            }
        ...
        $('#luckysheet-left-top').click(function (event) {
            if (!g.checkProtectionAllSelected(Store.currentSheetIndex)) {
                return;
            }
        ...
        $('#luckysheet-chart-rangeShow').on('mousedown.chartRangeShowResize', '.luckysheet-chart-rangeShow-resize', function (event) {
            Store.chart_selection.rangeResize = $(this).data('type');
            Store.luckysheet_scroll_status = true;
            ...
            if (selection.isPasteAction) {
                ...
                if (txtdata.indexOf('luckysheet_copy_action_table') > -1 && Store.luckysheet_copy_save['copyRange'] != null && Store.luckysheet_copy_save['copyRange'].length > 0) {
                    ...
                    if (copy_index == Store.currentSheetIndex) {
                        ...
                        d = Store.luckysheetfile[j.getSheetIndex(copy_index)].data;
                    }
            ...
            $('#luckysheet-bottom-page-next').click(function () {
                ...
                method.addDataAjax({
                    ...
                    if (luckysheetConfigsetting.pageInfo.totalPage == luckysheetConfigsetting.pageInfo.currentPage) {
                        ...
                        let pageInfoFull = i.replaceHtml(locale_info.pageInfoFull, {
                        ...
                        let pageInfo = i.replaceHtml(locale_info.pageInfo, {
                            total: luckysheetConfigsetting.total,
                            totalPage: luckysheetConfigsetting.pageInfo.totalPage,
    ...
    function hideUsername() {
        let $showEle = i.$$('.luckysheet-multipleRange-show');
        ...
        $showEle.forEach(ele => {
            ...
            if (Store.cooperativeEdit.usernameTimeout['user' + id] === null) {
                i.$$('.username', ele).style.display = 'none';
            }
        });
    }
});