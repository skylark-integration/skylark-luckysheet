define([
    ...
    '../store',
    './server'
], function (a, formula, b, c, menuButton, d, pivotTable, Store, server) {
    'use strict';
            ...
            if (curR == 0) {
                ...
                for (let c = startC; c <= endC; c++) {
                    ...
                    for (let r = curR - 1; r >= 0; r--) {
                        let cell = data[r][c];
                        if (a.getObjType(cell) == 'object' && b.isRealNull(cell.v)) {
                            stvalue.push(false);
                        } else if (b.isRealNull(cell)) {
                            stvalue.push(false);
                        } else {
                            stvalue.push(true);
                        }
    ...
    function getNextIndex(direction, focusIndex, strIndex, endIndex) {
        ...
        if (direction == 'down') {
            ...
            if (a.getObjType(stValue) == 'object' && b.isRealNull(stValue.v)) {
                stNull = true;
            } else if (b.isRealNull(stValue)) {
                stNull = true;
            } else {
                stNull = false;
            }
