define([
    ...
    '../locale/locale',
    '../store'
], function (a, b, c, d, formula, tooltip, editor, e, f, server, sheetmanage, luckysheetFreezen, menuButton, g, locale, Store) {
    'use strict';
    const hyperlinkCtrl = {
        item: {
            linkType: 'external',
        ...
        createDialog: function () {
            ...
            $('body').append(a.replaceHtml(e.modelHTML, {
        ...
        dataAllocation: function () {
            ...
            let text = b.getcellvalue(rowIndex, colIndex, null, 'm');
        ...
        ref: function (historyHyperlink, currentHyperlink, sheetIndex, d, range) {
            ...
            Store.luckysheetfile[g.getSheetIndex(sheetIndex)].hyperlink = currentHyperlink;
            Store.flowdata = d;
            editor.webWorkerFlowDataCache(Store.flowdata);
            Store.luckysheetfile[g.getSheetIndex(sheetIndex)].data = Store.flowdata;
