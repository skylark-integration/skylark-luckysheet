define([
    ...
    '../store',
    '../locale/locale'
], function (a, b, formula, c, tooltip, d, e, luckysheetsizeauto, server, f, Store, locale) {
    'use strict';
    const alternateformat = {
        ...
        getModelBox: function (hasRowHeader, hasRowFooter) {
            ...
            let modelCustom = Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)]['luckysheet_alternateformat_save_modelCustom'];
        ...
        init: function () {
            ...
            $('body').append(e.luckysheetAlternateformatHtml());
            luckysheetsizeauto();
            ...
            $(document).off('click.AFselectColorConfirm').on('click.AFselectColorConfirm', '#luckysheet-alternateformat-colorSelect-dialog-confirm', function () {
                ...
                if (index < len) {
                    ...
                    file = Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)];
        ...
        perfect: function () {
            ...
            let obj = $.extend(true, {}, Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)]['luckysheet_alternateformat_save'][existsIndex]);
            let cellrange = obj['cellrange'];
            $('#luckysheet-alternateformat-range input').val(a.getRangetxt(Store.currentSheetIndex, {
                'row': cellrange['row'],
        ...
        colorSelectDialog: function (currenColor, colorType, source) {
            ...
            $('body').append(b.replaceHtml(e.modelHTML, {
        ...
        rangeIsExists: function (range, index) {
            ...
            let AFarr = $.extend(true, [], Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)]['luckysheet_alternateformat_save']);
        ...
        getFormatByIndex: function () {
            ...
            if (index < len) {
                ...
                format = Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)]['luckysheet_alternateformat_save_modelCustom'][index - len];
            }
            return format;
        },
