define([
    ...
    '../store',
    '../locale/locale'
], function (a, b, c, tooltip, d, e, conditionformat, Store, locale) {
    'use strict';
    const luckysheetLocationCell = {
        createDialog: function () {
            ...
            $('body').append(a.replaceHtml(d.modelHTML, {
        ...
        apply: function (range, type, value) {
            ...
            if (type == 'locationFormula' || type == 'locationConstant' || type == 'locationNull') {
                ...
                for (let s = 0; s < range.length; s++) {
                    ...
                    for (let r = st_r; r <= ed_r; r++) {
                        for (let c = st_c; c <= ed_c; c++) {
                            ...
                            if (type == 'locationFormula' && cell != null && !c.isRealNull(cell.v) && cell.f != null && (value == 'all' || cell.ct != null && value.indexOf(cell.ct.t) > -1)) {
                                cellSave[r + '_' + c] = 0;
                            } else if (type == 'locationConstant' && cell != null && !c.isRealNull(cell.v) && (value == 'all' || cell.ct != null && value.indexOf(cell.ct.t) > -1)) {
                                cellSave[r + '_' + c] = 0;
                            } else if (type == 'locationNull' && (cell == null || c.isRealNull(cell.v))) {
                                cellSave[r + '_' + c] = 0;
                            }
                        }
                    }
                ...
                let index = b.getSheetIndex(Store.currentSheetIndex);
