define(['../utils/util'], function (a) {
    ...
    const analysis = {
        'STDEVP': function (mean, array1d) {
            ...
            return a.numFormat(Math.sqrt(cov / array1d.length));
        },
        'STDEV': function (mean, array1d) {
            ...
            return a.numFormat(Math.sqrt(cov / (array1d.length - 1)));
        },
        'VARP': function (mean, array1d) {
            ...
            return a.numFormat(cov / array1d.length);
        },
        'let': function (mean, array1d) {
            ...
            return a.numFormat(cov / (array1d.length - 1));
        }
    };
    return analysis;
});