define([
    ...
    function genarate(value) {
        ...
        if (value.toString().substr(0, 1) === "'") {
        ...
        } else if (a.isRealNum(value) && Math.abs(parseFloat(value)) > 0 && (Math.abs(parseFloat(value)) >= 100000000000 || Math.abs(parseFloat(value)) < 1e-9)) {
            ...
            if (index == value.toString().length - 1 && a.isRealNum(value3)) {
                if (value2.indexOf('.') > -1) {
            ...
            if (value.toString().indexOf('.') == value.toString().lastIndexOf('.')) {
                ...
                if (value1.indexOf(',') > -1) {
                    ...
                    for (var i = 1; i < ThousandsArr.length; i++) {
                        if (!a.isRealNum(ThousandsArr[i]) || ThousandsArr[i].length < 3) {
                            isThousands = false;
                            break;
                        }
                    }
                    ...
                    if (a.isRealNum(value1) && a.isRealNum(value2)) {
                        ct = {
                            'fa': '0.' + new Array(len + 1).join('0'),
                            't': 'n'
                        };
            ...
            v = parseFloat(value);
        } else if (b.isdatetime(value) && (value.toString().indexOf('.') > -1 || value.toString().indexOf(':') > -1 || value.toString().length < 16)) {
    ...
    function valueShowEs(r, c, d) {
        var value = c.getcellvalue(r, c, d, 'm');
        if (value == null) {
            value = c.getcellvalue(r, c, d, 'v');
        } else {
