define([
    ...
    '../store'
], function (a, menuButton, b, c, d, e, Store) {
    'use strict';
        ...
        for (let r = r1; r <= r2; r++) {
            ...
            for (let c = 0; c < d[r].length; c++) {
                ...
                if (cell != null && (cell.v != null || e.isInlineStringCell(cell))) {
                    let cellWidth = c.colLocationByIndex(c)[1] - c.colLocationByIndex(c)[0] - 2;
    ...
    function getCellTextInfo(cell, ctx, option) {
        ...
        let horizonAlign = b.checkstatusByCell(cell, 'ht');
        let verticalAlign = b.checkstatusByCell(cell, 'vt');
        let tb = b.checkstatusByCell(cell, 'tb');
        let tr = b.checkstatusByCell(cell, 'tr');
        let rt = b.checkstatusByCell(cell, 'rt');
        ...
        if (e.isInlineStringCell(cell)) {
            ...
            for (let i = 0; i < sharedStrings.length; i++) {
                ...
                let scfontset = a.luckysheetfontformat(shareCell);
            ...
            fontset = a.luckysheetfontformat(cell);
            ctx.font = fontset;
            cancelLine = b.checkstatusByCell(cell, 'cl');
            underLine = b.checkstatusByCell(cell, 'un');
            fontSize = b.checkstatusByCell(cell, 'fs');
