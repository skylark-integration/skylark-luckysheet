define([
    ...
    '../store',
    '../global/method'
], function (luckysheetFreezen, m_sheetSearch, m_refresh, Store, method) {
    'use strict';
    ...
    return function luckysheetscrollevent(isadjust) {
        ...
        let scrollLeft = $('#luckysheet-scrollbar-x').scrollLeft(), scrollTop = $('#luckysheet-scrollbar-y').scrollTop(), canvasHeight = $('#luckysheetTableContent').height();    // canvas高度
