define([
    ...
    function getBorderInfoComputeRange(dataset_row_st, dataset_row_ed, dataset_col_st, dataset_col_ed, sheetIndex) {
        ...
        if (sheetIndex == null) {
            ...
            cfg = Store.luckysheetfile[m_get.getSheetIndex(sheetIndex)].config;
            data = Store.luckysheetfile[m_get.getSheetIndex(sheetIndex)].data;
        }
                        ...
                        if (borderType == 'border-left') {
                            for (let bd_r = bd_r1; bd_r <= bd_r2; bd_r++) {
                                ...
                                if (bd_c_left >= 0 && borderInfoCompute[bd_r + '_' + bd_c_left]) {
                                    if (data[bd_r] != null && m_util.getObjType(data[bd_r][bd_c_left]) == 'object' && data[bd_r][bd_c_left].mc != null) {
                            ...
                            for (let bd_r = bd_r1; bd_r <= bd_r2; bd_r++) {
                                ...
                                if (bd_c_right < data[0].length && borderInfoCompute[bd_r + '_' + bd_c_right]) {
                                    if (data[bd_r] != null && m_util.getObjType(data[bd_r][bd_c_right]) == 'object' && data[bd_r][bd_c_right].mc != null) {
                            ...
                            for (let bd_c = bd_c1; bd_c <= bd_c2; bd_c++) {
                                ...
                                if (bd_r_top >= 0 && borderInfoCompute[bd_r_top + '_' + bd_c]) {
                                    if (data[bd_r_top] != null && m_util.getObjType(data[bd_r_top][bd_c]) == 'object' && data[bd_r_top][bd_c].mc != null) {
                            ...
                            for (let bd_c = bd_c1; bd_c <= bd_c2; bd_c++) {
                                ...
                                if (bd_r_bottom < data.length && borderInfoCompute[bd_r_bottom + '_' + bd_c]) {
                                    if (data[bd_r_bottom] != null && b.getObjType(data[bd_r_bottom][bd_c]) == 'object' && data[bd_r_bottom][bd_c].mc != null) {
                            ...
                            for (let bd_r = bd_r1; bd_r <= bd_r2; bd_r++) {
                                ...
                                for (let bd_c = bd_c1; bd_c <= bd_c2; bd_c++) {
                                    if (data[bd_r] != null && b.getObjType(data[bd_r][bd_c]) == 'object' && data[bd_r][bd_c].mc != null) {
                                    ...
                                    if (bd_r == bd_r1) {
                                        let bd_r_top = bd_r1 - 1;
                                        if (bd_r_top >= 0 && borderInfoCompute[bd_r_top + '_' + bd_c]) {
                                            if (data[bd_r_top] != null && b.getObjType(data[bd_r_top][bd_c]) == 'object' && data[bd_r_top][bd_c].mc != null) {
                                                let cell_top = data[bd_r_top][bd_c];
                                                let mc = cfg['merge'][cell_top.mc.r + '_' + cell_top.mc.c];
                                                if (mc.r + mc.rs - 1 == bd_r_top) {
                                                    borderInfoCompute[bd_r_top + '_' + bd_c].b = {
                                    ...
                                    if (bd_c == bd_c1) {
                                        let bd_c_left = bd_c1 - 1;
                                        if (bd_c_left >= 0 && borderInfoCompute[bd_r + '_' + bd_c_left]) {
                                            if (data[bd_r] != null && b.getObjType(data[bd_r][bd_c_left]) == 'object' && data[bd_r][bd_c_left].mc != null) {
                                                let cell_left = data[bd_r][bd_c_left];
                                                let mc = cfg['merge'][cell_left.mc.r + '_' + cell_left.mc.c];
                                                if (mc.c + mc.cs - 1 == bd_c_left) {
                                                    borderInfoCompute[bd_r + '_' + bd_c_left].r = {
                                    ...
                                    if (bd_c == bd_c2) {
                                        let bd_c_right = bd_c2 + 1;
                                        if (bd_c_right < data[0].length && borderInfoCompute[bd_r + '_' + bd_c_right]) {
                                            if (data[bd_r] != null && b.getObjType(data[bd_r][bd_c_right]) == 'object' && data[bd_r][bd_c_right].mc != null) {
                                                let cell_right = data[bd_r][bd_c_right];
                                                let mc = cfg['merge'][cell_right.mc.r + '_' + cell_right.mc.c];
                                                if (mc.c == bd_c_right) {
                                                    borderInfoCompute[bd_r + '_' + bd_c_right].l = {
