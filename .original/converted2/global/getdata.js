define([
    ...
    function getdatabyselection(range, sheetIndex) {
        ...
        if (sheetIndex != null && sheetIndex != Store.currentSheetIndex) {
            d = Store.luckysheetfile[m_get.getSheetIndex(sheetIndex)]['data'];
    ...
    function getdatabyselectionD(d, range) {
        ...
        let dynamicArray_compute = m_dynamicArray.dynamicArrayCompute(Store.luckysheetfile[m_get.getSheetIndex(Store.currentSheetIndex)]['dynamicArray']);
        let data = [];
        if (d == null) {
            return data;
        }
    ...
    function getcellvalue(r, c, data, type) {
        ...
        let retv = d_value;
        if (util.getObjType(d_value) == 'object') {
            retv = d_value[type];
            if (type == 'f' && retv != null) {
    ...
    function getRealCellValue(r, c) {
        ...
        if (value == null) {
            ...
            if (value == null) {
                ...
                if (m_inlineString.isInlineStringCT(ct)) {
                    value = ct.s;
                }
            }
        }
    ...
    function checkstatusByCell(cell, a) {
        ...
        if (a in tf || a == 'fs' && m_inlineString.isInlineStringCell(cell)) {
            if (foucsStatus == null) {
                foucsStatus = '0';
            } else {
