define([
    ...
    './createsheet',
    '../store'
], function (server, constant, sheetmanage, luckysheetformula, imageCtrl, dataVerificationCtrl, pivotTable, luckysheetFreezen, b, c, luckysheetConfigsetting, editor, luckysheetcreatesheet, Store) {
    'use strict';
    const defaultConfig = {
        defaultStore:{
            container: null, 
    ...
    //翻页
        addDataAjax: function (param, index, url, func) {
            ...
            $('#luckysheet-grid-window-1').append(constant.luckysheetlodingHTML());
            param.currentPage++;
     ...
     //重载
       reload: function (param, index, url, func) {
        ...
        editorChart: function (c) {
            let chart_selection_color = constant.luckyColor[0];
