define([
    ...
    './inlineString',
    '../store'
], function (luckysheetConfigsetting, menuButton, conditionformat, server, a, b, c, d, selection, searchReplace, controlHistory, imageCtrl, e, f, g, h, formula, cleargridelement, tooltip, locale, i, Store) {
    'use strict';
    ...
    function formulaMoveEvent(dir, ctrlKey, shiftKey, event) {
        if ($('#luckysheet-formula-search-c').is(':visible') && (dir == 'up' || dir == 'down')) {
            ...
            if ($('#luckysheet-formula-functionrange-select').is(':visible')) {
                if (ctrlKey && shiftKey) {
                    c.luckysheetMoveHighlightRange2(dir, 'rangeOfFormula');
                } else if (ctrlKey) {
                    c.luckysheetMoveHighlightCell2(dir, 'rangeOfFormula');
                } else if (shiftKey) {
                    ...
                    c.luckysheetMoveHighlightRange(dir_n, step, 'rangeOfFormula');
                } else {
                    let dir_n = dir, step = 1;
                    if (dir == 'up') {
                        dir_n = 'down';
                    ...
                    c.luckysheetMoveHighlightCell(dir_n, step, 'rangeOfFormula');
                }
                event.preventDefault();
                ...
                if (dir == 'up') {
                    ...
                    if (anchor.parent().is('span') && anchor.parent().prev().length == 0 && anchorOffset == 0) {
                        formula.updatecell(Store.luckysheetCellUpdate[0], Store.luckysheetCellUpdate[1]);
                        c.luckysheetMoveHighlightCell('right', -1, 'rangeOfSelect');
                        event.preventDefault();
    ...
    function keyboardInitial() {
        ...
        $('#luckysheet-input-box').click(function () {
            ...
            if ($('#luckysheet-modal-dialog-mask').is(':visible') || $(event.target).hasClass('luckysheet-mousedown-cancel') || $(event.target).hasClass('sp-input') || parseInt($('#luckysheet-input-box').css('top')) > 0 && $(event.target).closest('.luckysheet-input-box').length > 0 && kcode != b.keycode.ENTER && kcode != b.keycode.TAB && kcode != b.keycode.UP && kcode != b.keycode.DOWN && kcode != b.keycode.LEFT && kcode != b.keycode.RIGHT) {
                let anchor = $(window.getSelection().anchorNode);
                if (anchor.parent().is('#luckysheet-helpbox-cell') || anchor.is('#luckysheet-helpbox-cell')) {
                    if (kcode == b.keycode.ENTER) {
            ...
            if ((altKey || event.metaKey) && kcode == b.keycode.ENTER && parseInt($inputbox.css('top')) > 0) {
                let last = Store.luckysheet_select_save[Store.luckysheet_select_save.length - 1];
                let row_index = last['row_focus'], col_index = last['column_focus'];
                i.enterKeyControll(Store.flowdata[row_index][col_index]);
                event.preventDefault();
            } else if (kcode == b.keycode.ENTER && parseInt($inputbox.css('top')) > 0) {
                ...
                event.preventDefault();
            } else if (kcode == b.keycode.TAB) {
                if (parseInt($inputbox.css('top')) > 0) {
                    return;
                }
                c.luckysheetMoveHighlightCell('right', 1, 'rangeOfSelect');
                event.preventDefault();
            } else if (kcode == b.keycode.F2) {
                if (parseInt($inputbox.css('top')) > 0) {
                    return;
                }
                let last = Store.luckysheet_select_save[Store.luckysheet_select_save.length - 1];
                ...
                if (ctrlKey || event.metaKey) {
                    if (shiftKey) {
                        ...
                        if (kcode == b.keycode.UP) {
                            if (parseInt($inputbox.css('top')) > 0 || $('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                                return;
                            }
                            c.luckysheetMoveHighlightRange2('up', 'rangeOfSelect');
                        } else if (kcode == b.keycode.DOWN) {
                            if (parseInt($inputbox.css('top')) > 0 || $('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                                return;
                            }
                            c.luckysheetMoveHighlightRange2('down', 'rangeOfSelect');
                        } else if (kcode == b.keycode.LEFT) {
                            if (parseInt($inputbox.css('top')) > 0 || $('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                                return;
                            }
                            c.luckysheetMoveHighlightRange2('left', 'rangeOfSelect');
                        } else if (kcode == b.keycode.RIGHT) {
                            if (parseInt($inputbox.css('top')) > 0 || $('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                                return;
                            }
                            c.luckysheetMoveHighlightRange2('right', 'rangeOfSelect');
                        } else if (kcode == 186 || kcode == 222) {
                            let last = Store.luckysheet_select_save[Store.luckysheet_select_save.length - 1];
                            let row_index = last['row_focus'], col_index = last['column_focus'];
                            a.luckysheetupdateCell(row_index, col_index, Store.flowdata, true);
                            let value = e.getNowDateTime(2);
                            $('#luckysheet-rich-text-editor').html(value);
                            h.luckysheetRangeLast($('#luckysheet-rich-text-editor')[0]);
                        ...
                        if (Store.config['merge'] != null) {
                            ...
                            for (let s = 0; s < Store.luckysheet_select_save.length; s++) {
                                ...
                                has_PartMC = g.hasPartMC(Store.config, r1, r2, c1, c2);
                                if (has_PartMC) {
                                    break;
                                }
                            }
                        ...
                        let cdformat = Store.luckysheetfile[f.getSheetIndex(Store.currentSheetIndex)].luckysheet_conditionformat_save;
                        ...
                        event.stopPropagation();
                        return;
                    } else if (kcode == b.keycode.UP) {
                        if (parseInt($inputbox.css('top')) > 0 || $('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                            return;
                        }
                        c.luckysheetMoveHighlightCell2('up', 'rangeOfSelect');
                    } else if (kcode == b.keycode.DOWN) {
                        if (parseInt($inputbox.css('top')) > 0 || $('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                            return;
                        }
                        c.luckysheetMoveHighlightCell2('down', 'rangeOfSelect');
                    } else if (kcode == b.keycode.LEFT) {
                        if (parseInt($inputbox.css('top')) > 0 || $('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                            return;
                        }
                        c.luckysheetMoveHighlightCell2('left', 'rangeOfSelect');
                    } else if (kcode == b.keycode.RIGHT) {
                        if (parseInt($inputbox.css('top')) > 0 || $('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                            return;
                        }
                        c.luckysheetMoveHighlightCell2('right', 'rangeOfSelect');
                    } else if (kcode == 186) {
                        let last = Store.luckysheet_select_save[Store.luckysheet_select_save.length - 1];
                        let row_index = last['row_focus'], col_index = last['column_focus'];
                        a.luckysheetupdateCell(row_index, col_index, Store.flowdata, true);
                        let value = e.getNowDateTime(1);
                        $('#luckysheet-rich-text-editor').html(value);
                        h.luckysheetRangeLast($('#luckysheet-rich-text-editor')[0]);
                        formula.functionInputHanddler($('#luckysheet-functionbox-cell'), $('#luckysheet-rich-text-editor'), kcode);
                    } else if (kcode == 222) {
                    ...
                    event.preventDefault();
                    return;
                } else if (shiftKey && (kcode == b.keycode.UP || kcode == b.keycode.DOWN || kcode == b.keycode.LEFT || kcode == b.keycode.RIGHT || altKey && (kcode == 53 || kcode == 101))) {
                    ...
                    if (kcode == b.keycode.UP) {
                        ...
                        c.luckysheetMoveHighlightRange('down', -1, 'rangeOfSelect');
                    } else if (kcode == b.keycode.DOWN) {
                        if ($('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                            return;
                        }
                        ...
                        c.luckysheetMoveHighlightRange('right', -1, 'rangeOfSelect');
                    } else if (kcode == b.keycode.RIGHT) {
                        if ($('#luckysheet-singleRange-dialog').is(':visible') || $('#luckysheet-multiRange-dialog').is(':visible')) {
                            return;
                        }
                    ...
                    d.selectHightlightShow();
                } else if (kcode == b.keycode.DELETE || kcode == b.keycode.BACKSPACE) {
                    if (imageCtrl.currentImgId != null) {
                    ...
                    if (String.fromCharCode(kcode) != null && $('#luckysheet-cell-selected').is(':visible') && (kcode != b.keycode.CAPSLOCK && kcode != b.keycode.WIN && kcode != 18)) {
                        let last = Store.luckysheet_select_save[Store.luckysheet_select_save.length - 1];
                        let row_index = last['row_focus'], col_index = last['column_focus'];
                        a.luckysheetupdateCell(row_index, col_index, Store.flowdata, true);
                        if (kcode == 8) {
        ...
        $('#' + Store.container).add('#luckysheet-input-box').keydown(function (event) {
            ...
            let kcode = event.keyCode;
            let $inputbox = $('#luckysheet-input-box');
            if (kcode == b.keycode.ESC && parseInt($('#luckysheet-input-box').css('top')) > 0) {
                formula.dontupdate();
                c.luckysheetMoveHighlightCell('down', 0, 'rangeOfSelect');
                event.preventDefault();
            } else if (kcode == b.keycode.ENTER && parseInt($inputbox.css('top')) > 0) {
            ...
            } else if (kcode == b.keycode.TAB && parseInt($inputbox.css('top')) > 0) {
                if ($('#luckysheet-formula-search-c').is(':visible') && formula.searchFunctionCell != null) {
                    formula.searchFunctionEnter($('#luckysheet-formula-search-c').find('.luckysheet-formula-search-item-active'));
                } else {
                    formula.updatecell(Store.luckysheetCellUpdate[0], Store.luckysheetCellUpdate[1]);
            ...
            } else if (!(kcode >= 112 && kcode <= 123 || kcode <= 46 || kcode == 144 || kcode == 108 || event.ctrlKey || event.altKey || event.shiftKey && (kcode == 37 || kcode == 38 || kcode == 39 || kcode == 40 || kcode == b.keycode.WIN || kcode == b.keycode.WIN_R || kcode == b.keycode.MENU)) || kcode == 8 || kcode == 32 || kcode == 46 || event.ctrlKey && kcode == 86) {
                formula.functionInputHanddler($('#luckysheet-functionbox-cell'), $('#luckysheet-rich-text-editor'), kcode);
                a.setCenterInputPosition(Store.luckysheetCellUpdate[0], Store.luckysheetCellUpdate[1], Store.flowdata);
            }
        }).keyup(function (e) {
            let kcode = e.keyCode;
        ...
        $('#luckysheet_info_detail_input').val(server.title).css('width', e.getByteLen(server.title) * 10).keydown(function () {
            let ctrlKey = event.ctrlKey;
            let altKey = event.altKey;
            let shiftKey = event.shiftKey;
            let kcode = event.keyCode;
            ...
            let $t = $(this);
            let inputlen = e.getByteLen($t.val()) * 10;
