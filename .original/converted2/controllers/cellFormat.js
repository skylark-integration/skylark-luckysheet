define([
    ...
    function initialCellFormatModelEvent() {
        ...
        $('#luckysheet-cellFormat-confirm').click(function () {
            ...
            let d = recycleSeletion(function (cell, r, c, data) {
                if (cell == null) {
                    m_setdata.setcellvalue(r, c, data, {
                        lo: locked,
                        hi: hidden
                    });
                } else {
            ...
            m_refresh.jfrefreshgrid(d, undefined, undefined, false);
    ...
    function openCellFormatModel() {
        ...
        if (!m_protection.checkProtectionNotEnable(Store.currentSheetIndex)) {
            return;
        }
        ...
        m_util.openSelfModel('luckysheet-cellFormat-config');
    }
