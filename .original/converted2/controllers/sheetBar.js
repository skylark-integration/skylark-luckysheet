define([
    ...
    '../global/api'
], function (sheetmanage, server, a, b, c, d, formula, cleargridelement, tooltip, e, locale, Store, luckysheetConfigsetting, f) {
    'use strict';
    e.selectTextDom;
    ...
    function showsheetconfigmenu() {
        if (!isInitialSheetConfig) {
            ...
            $('#luckysheetsheetconfigcolorur').spectrum({
                ...
                change: function (color) {
                    ...
                    let index = c.getSheetIndex(Store.currentSheetIndex);
        ...
        setTimeout(function () {
            b.mouseclickposition($('#luckysheet-rightclick-sheet-menu'), luckysheetcurrentSheetitem.offset().left + luckysheetcurrentSheetitem.width(), luckysheetcurrentSheetitem.offset().top - 18, 'leftbottom');
        }, 1);
    }
    ...
    function initialSheetBar() {
        ...
        $('#luckysheet-sheets-m').click(function (e) {
            ...
            for (let i = 0; i < Store.luckysheetfile.length; i++) {
                ...
                item += b.replaceHtml(a.sheetselectlistitemHTML, {
                    'index': f['index'],
                    'name': f['name'],
                    'icon': icon,
                    'style': style
            ...
            if (initialOpenSheet) {
                $('#' + Store.container).append(b.replaceHtml(a.sheetselectlistHTML, { 'item': item }));
        ...
        if (luckysheetConfigsetting.pager) {
            f.pagerInit(luckysheetConfigsetting.pager);
        }
    }
