define([
    ...
    const alternateformat = {
        ...
        getModelBox: function (hasRowHeader, hasRowFooter) {
            ...
            let modelCustom = Store.luckysheetfile[m_get.getSheetIndex(Store.currentSheetIndex)]['luckysheet_alternateformat_save_modelCustom'];
        ...
        init: function () {
            ...
            $('body').append(m_constant.luckysheetAlternateformatHtml());
            luckysheetsizeauto();
            ...
            $(document).off('click.AFselectColorConfirm').on('click.AFselectColorConfirm', '#luckysheet-alternateformat-colorSelect-dialog-confirm', function () {
                ...
                if (index < len) {
                    ...
                    file = Store.luckysheetfile[m_get.getSheetIndex(Store.currentSheetIndex)];
        ...
        perfect: function () {
            ...
            let obj = $.extend(true, {}, Store.luckysheetfile[m_get.getSheetIndex(Store.currentSheetIndex)]['luckysheet_alternateformat_save'][existsIndex]);
            let cellrange = obj['cellrange'];
            $('#luckysheet-alternateformat-range input').val(m_get.getRangetxt(Store.currentSheetIndex, {
                'row': cellrange['row'],
        ...
        rangeDialog: function (value) {
            ...
            const alternatingColors = _locale.alternatingColors;
            const locale_button = _locale.button;
            $('body').append(m_util.replaceHtml(m_constanv.modelHTML, {
        ...
        rangeIsExists: function (range, index) {
            ...
            let AFarr = $.extend(true, [], Store.luckysheetfile[m_get.getSheetIndex(Store.currentSheetIndex)]['luckysheet_alternateformat_save']);
        ...
        getFormatByIndex: function () {
            ...
            if (index < len) {
                ...
                format = Store.luckysheetfile[m_get.getSheetIndex(Store.currentSheetIndex)]['luckysheet_alternateformat_save_modelCustom'][index - len];
            }
            return format;
        },
