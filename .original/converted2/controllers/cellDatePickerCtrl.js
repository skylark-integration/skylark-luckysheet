define([
    ...
    const cellDatePickerCtrl = {
        cellFocus: function (r, c, cell) {
            ...
            let defaultDate = m_format.update('yyyy-MM-dd hh:mm:ss', cell.v);
            ...
            const fp = flatpickr('#luckysheet-input-box', {
                ...
                onChange: function (selectedDates, dateStr) {
                    let currentVal = m_format.datenum_local(new Date(selectedDates));
                    $('#luckysheet-rich-text-editor').html(dateStr);
                    m_api.setCellValue(r, c, currentVal, { isRefresh: false });
                    m_api.setCellFormat(r, c, 'ct', cell.ct);
                    if (!enableTime) {
