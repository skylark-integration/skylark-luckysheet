define([
    ...
    '../store',
    '../locale/locale'
], function (a, b, c, d, server, menuButton, luckysheetPostil, luckysheetDropCell, e, Store, locale) {
    'use strict';
    const luckysheetFreezen = {
        ...
        cancelFreezenVertical: function (sheetIndex) {
            ...
            let currentSheet = Store.luckysheetfile[a.getSheetIndex(sheetIndex)];
        ...
        createFreezenVertical: function (freezenverticaldata, left) {
            ...
            if (freezenverticaldata == null) {
                ...
                let dataset_col_st = b.luckysheet_searcharray(Store.visibledatacolumn, scrollLeft);
                if (dataset_col_st == -1) {
                    dataset_col_st = 0;
                }
        ...
        saveFreezen: function (freezenhorizontaldata, top, freezenverticaldata, left) {
            let currentSheet = Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)];
            if (currentSheet.freezen == null) {
        ...
        changeFreezenIndex: function (originindex, type) {
            ...
            if (type == 'v' && _this.freezenverticaldata != null) {
                ...
                let offset = b.luckysheet_searcharray(Store.visibledatacolumn, $('#luckysheet-cell-main').scrollLeft());
                ...
                let offset = b.luckysheet_searcharray(Store.visibledatarow, $('#luckysheet-cell-main').scrollTop());
        ...
        scrollFreezen: function () {
            ...
            if (_this.freezenverticaldata != null) {
                let freezen_colindex = _this.freezenverticaldata[1];
                let offset = b.luckysheet_searcharray(_this.freezenverticaldata[3], $('#luckysheet-cell-main').scrollLeft());
            ...
            if (_this.freezenhorizontaldata != null) {
                let freezen_rowindex = _this.freezenhorizontaldata[1];
                let offset = b.luckysheet_searcharray(_this.freezenhorizontaldata[3], $('#luckysheet-cell-main').scrollTop());
        ...
        createFreezenHorizontal: function (freezenhorizontaldata, top) {
            ...
            if (freezenhorizontaldata == null) {
                ...
                let dataset_row_st = b.luckysheet_searcharray(Store.visibledatarow, scrollTop);
                if (dataset_row_st == -1) {
                    dataset_row_st = 0;
                }
        ...
        scrollAdapt: function () {
            ...
            if ($('#luckysheet-cell-main .luckysheet-data-visualization-chart').length > 0) {
                const chart = Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)]['chart'];
        ...
        scrollAdaptOfdpicon: function () {
            ...
            if (_this.freezenhorizontaldata != null && _this.freezenverticaldata != null) {
                let freezen_rowindex = _this.freezenhorizontaldata[1];
                let offsetRow = b.luckysheet_searcharray(_this.freezenhorizontaldata[3], $('#luckysheet-cell-main').scrollTop() - _this.freezenhorizontaldata[2]);
                let freezen_colindex = _this.freezenverticaldata[1];
                let offsetColumn = b.luckysheet_searcharray(_this.freezenverticaldata[3], $('#luckysheet-cell-main').scrollLeft() - _this.freezenverticaldata[2]);
                if (row_index >= freezen_rowindex && col_index >= freezen_colindex) {
                    ...
                    if (row_index < freezen_rowindex + offsetRow - 1) {
                        ...
                        let col = e.colLocationByIndex(col_index + offsetColumn)[1];
                    ...
                    if (col_index < freezen_colindex + offsetColumn - 1) {
                        ...
                        let row = e.rowLocationByIndex(row_index + offsetRow)[1];
                        $('#luckysheet-dropCell-icon').show().css('top', row);
                    }
                } else {
                    let row = e.rowLocationByIndex(row_index + offsetRow)[1], col = e.colLocationByIndex(col_index + offsetColumn)[1];
                ...
                let row = e.rowLocationByIndex(row_index)[1], col = e.colLocationByIndex(col_index)[1];
                $('#luckysheet-dropCell-icon').show().css({
                    'left': col,
                    'top': row
                });
        ...
        scrollAdaptOffilteroptions: function () {
            ...
            if (_this.freezenhorizontaldata != null && _this.freezenverticaldata != null) {
                ...
                d.createFilterOptions(Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)].filter_select);
            }
        },
        saveFrozen: function (operate, order, focus = {}) {
            if (order == null) {
                order = a.getSheetIndex(Store.currentSheetIndex);
            }
        ...
        frozenTofreezen: function () {
            let file = Store.luckysheetfile[a.getSheetIndex(Store.currentSheetIndex)];
            ...
            if (frozen.type === 'row') {
                let scrollTop = 0;
                let row_st = b.luckysheet_searcharray(Store.visibledatarow, scrollTop);
                if (row_st == -1) {
                    row_st = 0;
                }
                ...
                let scrollLeft = 0;
                let col_st = b.luckysheet_searcharray(Store.visibledatacolumn, scrollLeft);
                if (col_st == -1) {
                    col_st = 0;
                }
